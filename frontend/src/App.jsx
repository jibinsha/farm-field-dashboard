...
function App() {
  ...
  const [showAllFarmersMap, setShowAllFarmersMap] = useState(false)
  ...
  useEffect(() => {
    ...
    axios.get(
      'https://farm-field-dashboard.onrender.com/all-farmers'
    )
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{
                        color:
                          farmer['Cluster_Type'] === 'Far'
                            ? '#d00000'
                            : farmer['Cluster_Type'] === 'Moderate'
                            ? '#ff8800'
                            : '#2d6a4f',
                  ...
                  >
                    ...
                    <div>
                      {farmer['Distance_From_Office_KM']} KM from Office
                    </div>
...

          {
            ...
            >
              ...
              >
                ...
                <ZoomToFarmers farmers={allFarmers} />
